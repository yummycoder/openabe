...
int main(int argc, char* argv[])
{
    ...
    std::ofstream fout("../result/msgO_time_multi_NoList(attrLen:" + to_string(attr_length) + "msgLen:" + to_string(message_length) + ").txt", std::ios_base::app);
    ...
    pkScheme.multiEncryptNoList(attrs[0], attrs, attr_num, message, ct);

    //warmup
    pkScheme.multiDecryptNoList(attrs[0], attrs[attr_num-1], ct, dec);
