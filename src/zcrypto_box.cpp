...
bool OpenPKEContext::multiEncrypt(const string sender_id, const string receiver_ids[],
  ...
  if ((result = schemeContext_->multiEncrypt(nullptr, pkids,
...
int OpenPKEContext::multiDecrypt(const string sender_id, const string receiver_id, 
