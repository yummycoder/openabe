...
public:
  ...
  virtual OpenABE_ERROR multiEncryptKEM(OpenABERNG *rng, const std::vector<std::string>& pkIDs,
                           OpenABEByteString *senderID, uint32_t keyBitLen,
                           const std::shared_ptr<OpenABESymKey> &key,
...
public:
  ...
  OpenABE_ERROR multiEncryptKEM(OpenABERNG *rng, const std::vector<std::string>& pkIDs,
                           OpenABEByteString *senderID, uint32_t keyBitLen,
                           const std::shared_ptr<OpenABESymKey> &key,
                           OpenABECiphertext *ciphertext, std::unique_ptr<oabe::crypto::OpenABEMultiEveSymKeyAuthEnc> &symmEnc);
  OpenABE_ERROR multiDecryptKEM(const std::string &pkID, const std::string &skID,
                           OpenABECiphertext *ciphertext, uint32_t keyBitLen,
                           const std::shared_ptr<OpenABESymKey> &key,
...
public:
  ...
  OpenABE_ERROR multiEncrypt(OpenABERNG *rng, const std::vector<std::string>& pkIDs,
